...
select employee_name,salary from employee_salary
...
select employee_name,role_name from roles
...
select employee_name,monthly_salary from roles
join roles_employee on roles_employee.role_id = roles.id
join employees on roles_employee.employee_id = employees.id
join employee_salary on employee_salary.employee_id = roles_employee.employee_id
join salary on salary.id = employee_salary.salary_id
...
select COUNT(employee_name) from roles_employee
...
select COUNT(employee_name) from roles
join roles_employee on roles_employee.role_id = roles.id
join employees on roles_employee.employee_id = employees.id
join employee_salary on employee_salary.employee_id = roles_employee.employee_id
join salary on salary.id = employee_salary.salary_id
